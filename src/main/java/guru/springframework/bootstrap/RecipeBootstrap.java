...
/**
 * Created by Donald F. Coffin on 11/1/17
 */
@Slf4j
@Component
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.setDirections("1 Cut avocado, remove flesh: Cut the avocados in  half.  Remove seed. \" +" +
                ...
                "Place in a bowl" +
                "\n" +
                "2 Mash with a fork: Using a fork, roughly mash the avocado.  (Don't overdue it!  The guacamole " +
        ...
        guacNotes.setRecipeNotes("For a very quick guacamole just take a 1/4 cup of salsa and mix it in with mashed avocados.\n" +
        ...
        guacRecipe.addIngredients(new Ingredient("fresh lime juice or lemon juice", new BigDecimal(1), tableSpoonUom));
        ...
        guacRecipe.addIngredients(new Ingredient("freshly grated black pepper", new BigDecimal(1), dashUom));
        ...
        tacosRecipe.setDirections("1 Prepare a gas or charcoal grill for medium-high, direct heat.\n" +
                ...
                "4 Warm the tortillas: Place each tortilla on the grill or on a hot, dry skillet over medium-high heat.  As soon as you see pockets of the air start to puff up on the tortilla, turn it with tongs and heat for a few seconds on the other side.\n" +
                "Wrap warmed tortillas in a tea towel to keep them warm until serving.\n" +
                "5 Assemble the tacos: Slice the chicken into strips.  On each tortilla, place a small handful of arugula.  Top with chicken slices, sliced avocado, radish, tomatoes, and onion slices.  Drizzle with the thinned sour cream.  Serve with lime wedges");
        ...
        tacosRecipe.addIngredients(new Ingredient("Clove of Garlic, Chopped", new BigDecimal(1), eachUom));
        ...
        tacosRecipe.addIngredients(new Ingredient("small corn tortillas", new BigDecimal(8), eachUom));
        tacosRecipe.addIngredients(new Ingredient("packed baby arugula", new BigDecimal(3), cupsUom));
        tacosRecipe.addIngredients(new Ingredient("medium ripe avocados, sliced", new BigDecimal(2), eachUom));
